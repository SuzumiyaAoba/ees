...
import {
  EmbeddingService,
  type BatchCreateEmbeddingResponse,
...
describe("CLI Application Service Layer", () => {
  ...
  beforeEach(async () => {
    ...
    mockEmbeddingService = {
      ...
      createEmbeddingWithProvider: vi.fn(),
    }
    ...
    const baseLayer = Layer.mergeAll(
      ...
      Layer.succeed(EmbeddingService, mockEmbeddingService as unknown as typeof EmbeddingService.Service)
    )
